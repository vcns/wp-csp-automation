...
Rights granted under the GNU General Public License do not grant rights to use trademarks, service marks, logos, or branding owned by VCNS Tech Ltd.
...
Additional marks may be designated in future.

## 3. Permitted Use

You may use these trademarks solely for:

* referring to the original project;
* describing compatibility with the project;
* factual and non-misleading references;
* academic papers;
* reviews;
* blog articles;
...
* use the trademarks in a manner that implies endorsement;
* use logos without permission;
* use the trademarks to market a modified fork;
* create confusingly similar names;
* register confusingly similar domain names;
* use the branding in a way that may mislead users;
* claim to represent VCNS Tech Ltd;
* redistribute modified software under the original branding.
...
The GPL permits redistribution and modification of source code.

However, modified versions must not:
...
Attribution to the original project is encouraged.
...
## 7. Logos and Graphics

Logos, icons, images, and visual assets are proprietary and are not covered by GPL.

No licence is granted to reproduce or modify them except where explicitly authorised.

## 8. Domain Names

You must not register domain names that are likely to cause confusion with:
...
* official-wpcspautomation.com
* wpcspautomationpro.com
* wpcspautomation-enterprise.com

## 9. Reporting Misuse

Suspected misuse may be reported to:

[enquiries@vcns.tech](mailto:enquiries@vcns.tech)

VCNS Tech Ltd reserves the right to request cessation of trademark misuse and to pursue appropriate legal remedies where necessary.

## 10. Reservation of Rights

VCNS Tech Ltd reserves all rights not expressly granted by this policy.

No rights or licences are granted by implication.

## 11. Changes

This policy may be revised from time to time.

The latest version published by VCNS Tech Ltd supersedes previous versions.
